...
export default function ProjectCard({ project, index }) {
    return (
        <motion.article
            ...
            className="group flex h-full min-h-125 flex-col overflow-hidden rounded-[1.7rem] border border-black/8 bg-[#f7f7f5] transition-all duration-300 hover:-translate-y-1.5 hover:border-black/15 hover:shadow-2xl hover:shadow-black/10"
        >
            {/* Image area — clicks to case study */}
            <Link
                href={`/projects/${project.slug}`}
                className="relative block h-56 shrink-0 overflow-hidden bg-[#e5e5e1] p-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-black"
                tabIndex={-1}
                aria-hidden="true"
            >
            ...
            <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mt-8 flex items-center justify-between border-t border-black/8 pt-5">
                    <a
                        ...
                        className="inline-flex items-center gap-1.5 rounded-full bg-black px-4 py-2 text-[10px] font-black uppercase tracking-[0.18em] text-white transition-all hover:-translate-y-0.5 hover:shadow-md hover:shadow-black/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
                    ...
                    <Link
                        href={`/projects/${project.slug}`}
                        className="inline-flex items-center gap-1.5 text-[11px] font-black uppercase tracking-[0.18em] text-black/50 transition-all hover:gap-2.5 hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
